...
export function CurrentNextShiftCard({ shift }: { shift?: HomeShiftSummary }) {
  return <section className="dashboard-card dashboard-card--featured" aria-labelledby="home-shift-heading">
...
export function FleetAttentionCard({ items }: { items: EvaluatedMaintenanceTracker[] }) {
  return <section className="dashboard-card" aria-labelledby="fleet-attention-heading">
