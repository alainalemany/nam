...
| Document | Role |
| --- | --- |
| `README.md` | Repository overview and high-level project summary. |
| `docs/prd.md` | Confirmed product requirements. |
| `docs/modules.md` | Module definitions, workflows, capabilities, and boundaries. |
| `docs/database.md` | Entities, fields, relationships, enums, and data modeling. |
| `docs/architecture.md` | Architecture decisions, tradeoffs, boundaries, and consequences. |
| `docs/roadmap.md` | Phased implementation plan. |
| `docs/ideas.md` | Unapproved or future ideas needing evaluation. |
...
| `docs/database.md` | Entities, fields, relationships, enums, and data modeling. |
| `docs/architecture.md` | Architecture decisions, tradeoffs, boundaries, and consequences. |
| `docs/roadmap.md` | Phased implementation plans. |
| `docs/ideas.md` | Unapproved or future ideas needing evaluation. |
...
| Daily Log | Operator narrative layer and full-day activity record. |
| Shift Reports | Structured shift-level records connecting work activity, inspections, Work Authorizations, and related paperwork. |
| Work Authorizations | Safety and maintenance work records tied to a Shift Report. |
| Daily Inspections | Pre-shift and operational inspection findings. |
| Defect Tracking | Equipment issue tracking from report through closure. |
| Knowledge Base | Field notes, procedures, troubleshooting, safety notes, training, and equipment-specific knowledge. |
| Work Schedule | Manually entered weekly assignments and changes. |
| Timesheet | Personal weekly time entries, pay codes, work codes, equipment, comments, and totals. |
| Fuel Log | Diesel deliveries, gasoline purchases, gallons, vendors, pricing, receipts, and equipment links. |
| Work Truck Log | Work truck mileage, daily website log responses, submitted status, and related fuel activity. |
| Payslip Repository | Payslip PDFs and extracted payroll data in a separate financial context. |
