...
22. Relevant implementation files:
    ...
    - `compose.yaml`
    - `infrastructure/`
23. `docs/ideas.md` only when evaluating future or unapproved concepts.
