...
Work Authorization parent context, feature-owned list filtering, and Day View
...
- Feature-owned Shift Report list filtering by date range, shift, equipment,
  status, and text is implemented.
