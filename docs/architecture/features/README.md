...
| Supply Requests | [Supply Requests Architecture](supply-requests.md) | Architecture Approved; Phases 26.3A, 26.3B, 26.4 reference management, and 26.5 create/detail surfaces implemented and accepted; initial operator create and detail workflow available; fulfillment and cancellation not started; broader feature implementation incomplete |
