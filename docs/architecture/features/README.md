...
| Supply Requests | [Supply Requests Architecture](supply-requests.md) | Architecture Approved; Phase 26.3A persistence foundation and Phase 26.3B transactional initial-create persistence implemented and accepted; reference management and end-user surfaces not started; broader feature implementation incomplete |
