...
| Supply Requests | [Supply Requests Architecture](supply-requests.md) | Architecture Approved; Phases 26.3A, 26.3B, and 26.4 reference management implemented and accepted; request create/detail surfaces not started; broader feature implementation incomplete |
