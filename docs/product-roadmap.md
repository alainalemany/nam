...
| Equipment Fuel Events | Captures one Equipment fueling occurrence at one reusable Gas Station, including multi-tank Decimal gallons, historical price/cost, optional meter reading, and receipt reference. | Equipment and City reference data; ADR-020; feature architecture: `docs/architecture/features/equipment-fuel-events.md`; stronger value with Day View. | V1 and V2 Phase 1 implemented; V2 Phase 2A approved for implementation |
