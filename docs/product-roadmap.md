...
- Work Schedule, with approved feature architecture and implementation not yet
  started.
- Timesheet.
- Fuel Log.
- Work Truck Log.
...
| Work Schedule and Timesheet | Supports personal schedule and time reconciliation. | Reference data; stronger value with Day View. Work Schedule feature architecture: `docs/architecture/features/work-schedule.md`. | Work Schedule architecture approved; implementation not started. Timesheet planned |
